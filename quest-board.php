...
if ($search)     $where[] = "(title LIKE '%$search%' OR description LIKE '%$search%')";
if ($difficulty) $where[] = "difficulty = '$difficulty'";
if ($min_reward !== '') $where[] = "reward >= $min_reward";
if ($max_reward !== '') $where[] = "reward <= $max_reward";
if ($quest_type === 'solo')  $where[] = "is_party_quest = 0";
if ($quest_type === 'party') $where[] = "is_party_quest = 1";

$query = "SELECT * FROM quests WHERE " . implode(' AND ', $where) . " ORDER BY created_at DESC";
